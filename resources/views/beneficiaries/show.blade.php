                                ...
                                <div class="card-body p-0">
                                    <div class="alert alert-primary border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                        <div class="flex-grow-1 text-truncate">
                                            {{$event["event"]->assistanceType->name}}
                                        </div>
                                        <div class="flex-shrink-0" id="cancel-{{$event["event"]->id}}">
                                            @if($event["received"])
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-sm-8">
                                            <div class="p-3">
                                                <p class="fs-16 lh-base">{{ $event["event"]->event_name}}, {{$event["event"]->venue}}</p>
                                                <p class="fst-italic">{{ $event["event"]->notes}}</p>
                                                <div class="mt-3" id="claime-{{$event["event"]->id}}">
                                                        @if($event["received"])
                                                           <button type="button" class="btn btn-soft-success waves-effect claimed-assistance">Claimed</button>
                                                    @else
                                                            <button class="btn btn-primary receive-assistance" data-beneficiary-id="{{ $beneficiary->id }}" data-event-id="{{ $event["event"]->id }}">Claim Assistance</button>
                                                        @endif
