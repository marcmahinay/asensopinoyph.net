            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Municipalities / Cities</a></li>
                        <li class="breadcrumb-item active">Municipality/City List</li>
                    </ol>
                </div>
                                    ...
                                    @foreach ($municities as $municity)
                                        <tr>
                                            ...
                                            <td class="id" style="display:none;"><a href="javascript:void(0);"
                                                    class="fw-medium link-primary">{{$municity->id}}</a></td>
                                            <td class="municity_name">{{$municity->name}}</td>
                                            <td class="municity_province">{{$municity->province->name}}</td>
                                            <td>
