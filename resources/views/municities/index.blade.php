<x-app-layout>
    ...
    <x-slot name="footerScripts">
        ...
        <!-- crm leads init -->
        <script src="{{ asset('assets/js/app/municities.init.js') }}"></script>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Municipalities / Cities</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">Municipalities / Cities</li>
                ...
                <div class="card-body">
                    <div>
                        <div class="table-responsive table-card">
                            <table class="table align-middle" id="municityTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="" data-sort="municity_province">Province</th>
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0"> We
                                        did not find any
                                        city/municipality for you search.</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-12">
                                                <div>
                                                    ...
                                                    <select id="province_id-field" name="province_id" class="form-select" required>
