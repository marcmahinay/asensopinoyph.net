                            ...
                            <table class="table align-middle" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="" data-sort="barangay_municity">Municipality/City</th>
                                        <th class="" data-sort="barangay_province">Province</th>
                                        <th class="" data-sort="action">Action</th>
                                    </tr>
                                </thead>
                                <tbody id="barangayTableBody" class="list form-check-all">
                                    @foreach ($barangays as $barangay)
                                        <tr>
                                            ...
                                            <td class="id" style="display:none;"><a href="javascript:void(0);"
                                                    class="fw-medium link-primary">{{ $barangay->id }}</a></td>
                                            <td class="barangay_name">{{ $barangay->name }}</td>
                                            <td class="barangay_municity">{{ $barangay->municity->name }}</td>
                                            <td class="barangay_province">{{ $barangay->municity->province->name }}</td>
                                            <td>
